...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		bg = new FlxSprite().loadGraphic(Paths.image('Ristar/Art/CreditsArt'));
		add(bg);
		...
		var pisspoop:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['Vs Ristar Person'],
			['Greeny109',			'greeny109',		'Every Aspect of this mod',								'https://gamebanana.com/members/1828944', '79EB00'],
			[''],
			['Psych Engine Team'],
