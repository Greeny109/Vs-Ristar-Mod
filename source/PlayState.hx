...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		...
		['Can do Better', 0.6], //From 50% to 59%
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'schoolEvil': //Week 6 - Thorns
				...
				case 'feelspace': //Week Feel
				var bg:BGSprite = new BGSprite('Ristar/Stage', -600, -200, 0.7, 0.7);
				bg.scale.set(2, 2);
				add(bg);

				//no more LUA. cry about it. :p
		}
		...
		timeTxt.setFormat(Paths.font("16Bit.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		scoreTxt.setFormat(Paths.font("16Bit.ttf"), 20, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
		...
		botplayTxt.setFormat(Paths.font("16Bit.ttf"), 32, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
